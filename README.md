...
- **版本要求**：OpenClaw ≥ **2026.8.1**，通过 `openclaw -v` 查看。本版本使用新的插件 SDK、运行时配置快照以及 Host 管理的消息队列与中断语义；旧版宿主请继续使用插件 0.8.25，升级宿主后再升级插件。

> 如低于此版本，执行 `npm install -g openclaw@2026.8.1` 升级。
